...
- [Wowo51/Sym](https://github.com/Wowo51/Sym)  Symbolic computation framework for math and C# analysis, including Agent Skills (SKILL.md) for SymCLI.
...
- [t-bench / t�-bench](https://github.com/sierra-research/tau-bench) � Sierra Research benchmarks for Tool-Agent-User interaction. t�-bench extends to dual-control environment with telecom domain. ([Leaderboard](https://taubench.com/), [t� Paper](https://arxiv.org/abs/2506.07982))
...
- [Galileo Agent Leaderboard](https://huggingface.co/blog/pratikbhavsar/agent-leaderboard) � Evaluates agent tool selection quality across BFCL, t-bench, xLAM, and ToolACE datasets. *(Feb 2025)*
